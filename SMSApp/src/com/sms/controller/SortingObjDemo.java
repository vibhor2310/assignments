...
public class SortingObjDemo {
	public static void main(String[] args) {
		...
		InstructorService instrutorService = new InstructorService();
		
		// comparable
	    List<Instructor>list = 	instrutorService.getAllInstructors();
	    ...
	    System.out.println("-----------COMPARATOR---------------");
		 list = instrutorService.getAllInstructors();
